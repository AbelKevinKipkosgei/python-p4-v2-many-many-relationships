...
# Association model, many to many relationship between employee and project
class Assignment(db.Model):
    ...
    def __repr__(self):
        return f'<Assignment {self.id}, {self.role}, {self.start_date}, {self.employee.name}, {self.project.title}>'